...
module.exports = async (
  ...
  const yTitle = titleLength > 300 ? 100 : 80;
  ...
  ctx.setTransform(scale, 0, 0, scale, PADDING_LEFT, 860);
  ...
  ctx.font = `${25}px Inter ExtraBold`;
  ctx.fillStyle = "#03001C";
  ctx.fillText(`${writer}:`, 220, 910);
  // Write author name
  ctx.font = `${35}px Inter ExtraBold`;
  ctx.fillStyle = "#03001C";
  ctx.fillText(`git@${author}`, 220, 945);
